...
Stat:SetScript("OnEnter", function(self)
	if not InCombatLockdown() then
		...
		if bandwidth ~= 0 then
			GameTooltip:AddDoubleLine("Bandwidth: ", format("%s ".."Mbps", bandwidth), 0.69, 0.31, 0.31,0.84, 0.75, 0.65)
			GameTooltip:AddDoubleLine("Download: ", format("%s%%", floor(GetDownloadedPercentage()*100+0.5)), 0.69, 0.31, 0.31, 0.84, 0.75, 0.65)
			GameTooltip:AddLine(" ")
		end
