...
local function Update(self, event, ...)	
	if IsInGuild() then
		...
		Text:SetText('|cffffffffGuild:|r ' .. numOnline)
	else
		Text:SetText('No guild')
	end
end

local menuFrame = CreateFrame('Frame', addonName..'GuildRightClickMenu', UIParent, 'UIDropDownMenuTemplate')
local menuList = {
...
Stat:SetScript('OnEnter', function(self)
	if not InCombatLockdown() then
		if IsInGuild() then
			...
			GameTooltip:AddDoubleLine(GetGuildInfo('player'), format('Guild: %d/%d', online, total), tthead.r, tthead.g, tthead.b, tthead.r, tthead.g, tthead.b)
			GameTooltip:AddLine' '
